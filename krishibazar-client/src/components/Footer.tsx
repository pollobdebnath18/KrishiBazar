...
const footerLinks = {
  ...
  support: [
    ...
    { label: "যোগাযোগ", href: "/about" },
    { label: "প্রাইভেসি পলিসি", href: "/about" },
    { label: "শর্তাবলী", href: "/about" },
  ],
};
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-gray-500">
              কৃষক ও ক্রেতাদের মধ্যে সরাসরি সংযোগ স্থাপনকারী বিশ্বাসযোগ্য প্ল্যাটফর্ম।
            </p>
            <div className="mt-5 flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-gray-400 transition-all hover:bg-green-600 hover:text-white"
                >
                  {social.icon}
                </a>
              ))}
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-white/10 py-6 sm:flex-row">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} KrishiBazar. সর্বস্বত্ব সংরক্ষিত।
          </p>
